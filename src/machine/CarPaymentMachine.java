...
public class CarPaymentMachine implements PaymentMachine {
    ...
    public CarPaymentMachine(String timeIn, String timeOut) {
        this.timeIn = timeIn;
    ...
    public void setInsertedMoneyIn(String money, Coins coin, Notes note) {
        if (coin.isCoin(money)) {
            double coinMoney = coin.getMoneyNumeration(money);
            coin.setInsertedCoins(coinMoney);
            this.moneyIn.add(money);
        }
        if (note.isNotes(money)) {
            double noteMoney = note.getMoneyNumeration(money);
